...
<div class="fieldcontain ${hasErrors(bean: tekEventInstance, field: 'desc', 'error')} required">
	<label for="desc">
		<g:message code="tekEvent.desc.label" default="Desc" />
		<span class="required-indicator">*</span>
	</label>
	<g:textArea name="desc" cols="40" rows="5" maxlength="5000" required="" value="${tekEventInstance?.desc}"/>
...
<div class="fieldcontain ${hasErrors(bean: tekEventInstance, field: 'startDate', 'error')} required">
	...
	<g:datePicker name="startDate" precision="day"  value="${tekEventInstance?.startDate}" years="${2014..2024}" />
...
<div class="fieldcontain ${hasErrors(bean: tekEventInstance, field: 'endDate', 'error')} required">
	...
	<g:datePicker name="endDate" precision="day"  value="${tekEventInstance?.endDate}"  years="${2014..2024}" />
