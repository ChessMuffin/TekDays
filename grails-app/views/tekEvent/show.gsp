	...
	<body>
		...
		<div id="show-tekEvent" class="content scaffold-show" role="main">
			...
			<ol class="property-list tekEvent">
				...
				<li class="fieldcontain">
					<span id="desc-label" class="property-label"><g:message code="tekEvent.desc.label" default="Desc" /></span>
					
						<span class="property-value" aria-labelledby="desc-label"><g:fieldValue bean="${tekEventInstance}" field="desc"/></span>
